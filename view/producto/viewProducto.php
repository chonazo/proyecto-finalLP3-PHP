<section class="content-header">
    ...
    <br><br>
    <h1>
        <i class="fa fa-cube icon-title"></i> Datos de Productos
        <a class="btn btn-primary pull-right"
           href="index.php?controller=Producto&action=indexFormAdd"
...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            ...
            if (isset($_GET['alert'])) {
                $messages = [
                    1 => ['type' => 'success', 'text' => 'Producto registrado correctamente.'],
                    2 => ['type' => 'success', 'text' => 'Producto modificado correctamente.'],
                    3 => ['type' => 'success', 'text' => 'Producto eliminado correctamente.'],
            ...
            <div class="box box-primary">
                <div class="box-body">
                    <div class="text-right" style="margin-bottom: 10px;">
                        <a class="btn btn-warning" href="index.php?controller=Report&action=reporteProducto" title="Generar reporte PDF" data-toggle="tooltip">
                        ...
                        <tbody>
                            <?php if (!empty($productos)): ?>
                                <?php foreach ($productos as $p): ?>
                                    <tr>
                                        <td><?= htmlspecialchars($p['cod_producto']) ?></td>
                                        <td><?= htmlspecialchars($p['p_descrip']) ?></td>
                                        <td><?= htmlspecialchars($p['tipo_descrip']) ?></td>
                                        ...
                                        <td style="display: flex; justify-content: center; align-items: center; gap: 5px;">
                                            <a class="btn btn-primary btn-sm"
                                               href="index.php?controller=Producto&action=indexFormEdit&id=<?= $p['cod_producto']; ?>"
                                               title="Editar">
                                                <i class="glyphicon glyphicon-edit" style="color:#fff"></i>
                                            </a>
                                            <a class="btn btn-danger btn-sm"
                                               href="index.php?controller=Producto&action=delete&id=<?= $p['cod_producto']; ?>"
